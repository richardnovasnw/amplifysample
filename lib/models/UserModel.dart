...
class UserModel extends Model {
  ...
  const UserModel._internal({required this.id, name, age, phone, email, createdAt, updatedAt}): _name = name, _age = age, _phone = phone, _email = email, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory UserModel({String? id, String? name, int? age, String? phone, String? email}) {
  ...
  UserModel copyWith({String? id, String? name, int? age, String? phone, String? email}) {
    return UserModel._internal(
      id: id ?? this.id,
      name: name ?? this.name,
      age: age ?? this.age,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'age': _age, 'phone': _phone, 'email': _email, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
